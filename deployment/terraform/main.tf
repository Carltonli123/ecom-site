...
variable "name" {
  default = "mongodb_group"
}

######## Security group
resource "alicloud_security_group" "group" {
  name        = "sg_mongodb_app"
  description = "Security group for MongoDB app"
...
resource "alicloud_instance" "instance" {
  ...
  system_disk_name        = "mongodb_app_system_disk"
  system_disk_size        = 40
  system_disk_description = "mongodb_app_system_disk"
  image_id                = "centos_8_4_x64_20G_alibase_20210824.vhd"
  instance_name           = "mongodb_app"
...
######## MongoDB (Replica Set)
resource "alicloud_mongodb_instance" "demo" {
  engine_version      = "4.2"
